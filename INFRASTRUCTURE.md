...
> **`xavantys-corp/aws-organization-oidc`**
...
2. A role foi provisionada pelo StackSet CloudFormation mantido em `xavantys-corp/aws-organization-oidc`
...
```
xavantys-corp/aws-organization-oidc                    atividades_alunos (este repo)
...
1. Time de infra deploya StackSet de `xavantys-corp/aws-organization-oidc` na conta AWS
